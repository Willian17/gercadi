        ...
        <div className="site-container">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            {[
              ...
              return <article key={String(title)} className="rounded-lg border border-border bg-surface p-7"><ItemIcon className="size-7 text-tracking-green" aria-hidden="true" /><h2 className="mt-6 text-2xl font-bold text-ink">{String(title)}</h2><p className="mt-3 text-sm leading-6 text-muted">{String(text)}</p></article>;
            })}
          </div>
        </div>
      </section>
