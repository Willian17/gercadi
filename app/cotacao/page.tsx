...
export default async function QuotationPage({ searchParams }: PageProps<"/cotacao">) {
  const { destino } = await searchParams;
  const defaultDestination = typeof destino === "string" ? destino.slice(0, 100) : undefined;
