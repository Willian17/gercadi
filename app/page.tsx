...
export default function Home() {
  return (
    <>
      <section className="route-grid relative isolate -mt-28 min-h-[calc(100svh+2rem)] overflow-hidden bg-carbon-deep text-white md:-mt-27">
        <Image src="/images/company/caminhao-gercadi-estrada.jpg" alt="Caminhão da Gercadi em operação ao pôr do sol" fill priority sizes="100vw" className="object-cover object-[62%_center] opacity-70" />
        ...
        <div className="site-container relative z-10 flex min-h-[calc(100svh+2rem)] items-end pb-10 pt-44 sm:pb-14 md:pt-48 lg:pb-20">
          <div className="w-full">
            <div className="mb-8 flex items-center gap-4 text-[10px] font-extrabold uppercase tracking-[.25em] text-white/65"><span className="h-px w-12 bg-action-red" />Gercadi • Transporte e logística</div>
            <h1 className="display-condensed max-w-[1050px] text-[clamp(4.2rem,11vw,10rem)] uppercase">
              Mato Grosso<br /><span className="text-white/36">não para.</span><br />Sua carga também não.
            </h1>
            <div className="mt-10 grid gap-8 border-t border-white/20 pt-7 lg:grid-cols-[1fr_auto] lg:items-end">
      ...
      <section aria-label="Ações principais" className="relative z-20 bg-paper">
        <div className="site-container -translate-y-1/2">
          <div className="grid overflow-hidden rounded-2xl border border-black/10 bg-white shadow-[0_24px_70px_rgba(9,12,10,.18)] md:grid-cols-2">
        ...
        <div className="site-container">
          <div className="grid gap-14 lg:grid-cols-12 lg:items-end">
            <div className="lg:col-span-7">
              ...
              <h2 className="display-condensed text-[clamp(4rem,9vw,9rem)] uppercase text-carbon">Presença.<br />Ritmo.<br /><span className="text-action-red">Conexão.</span></h2>
            </div>
          ...
          <div className="mt-24 grid border-y border-black/15 sm:grid-cols-2 lg:grid-cols-4">
            {[ ["35+", "anos de experiência"], ["23", "unidades em Mato Grosso"], ["24h", "canal para urgências"], ["100%", "Mato Grosso"] ].map(([value, label], index) => (
              <div key={label} className="relative min-h-60 border-b border-black/15 p-6 last:border-b-0 sm:border-l lg:min-h-72 lg:border-b-0 lg:p-8">
                ...
                <strong className="display-condensed mt-10 block text-[clamp(4.5rem,8vw,7.5rem)] text-carbon">{value}</strong>
      ...
      <section className="bg-carbon text-white">
        <div className="site-container py-20 sm:py-28">
          <div className="flex flex-col gap-6 border-b border-white/15 pb-12 md:flex-row md:items-end md:justify-between">
            <div><p className="eyebrow eyebrow-inverse">Soluções em campo</p><h2 className="display-condensed text-[clamp(3.8rem,8vw,8rem)] uppercase">Cada carga pede<br /><span className="text-white/35">um movimento.</span></h2></div>
          ...
          <div className="divide-y divide-white/15">
            {serviceChapters.map((service, index) => {
              ...
              return (
                <article key={service.title} className="group grid gap-8 py-12 md:grid-cols-12 md:items-center md:py-16">
      ...
      <section className="paper-grid section-space bg-ivory">
        <div className="site-container grid gap-14 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-5">
            ...
            <h2 className="display-condensed text-[clamp(4rem,8vw,7.5rem)] uppercase text-carbon">23 pontos.<br /><span className="text-tracking-green">Um estado.</span></h2>
          ...
          <CoverageMap compact className="lg:col-span-6 lg:col-start-7" />
        </div>
      </section>

      <section className="section-space overflow-hidden bg-paper">
        <div className="site-container">
          <div className="grid gap-10 lg:grid-cols-12 lg:items-end"><div className="lg:col-span-7"><p className="eyebrow">Estrutura em movimento</p><h2 className="display-condensed text-[clamp(4rem,8vw,8rem)] uppercase text-carbon">Da base<br />para a estrada.</h2></div><p className="max-w-md text-lg leading-8 text-muted lg:col-span-4 lg:col-start-9">Frota e infraestrutura conectadas à presença regional para manter a operação avançando.</p></div>
          <div className="mt-16 grid gap-4 md:grid-cols-12 md:grid-rows-[300px_300px]">
      ...
      <section className="route-grid bg-carbon-deep py-20 text-white sm:py-28">
        <div className="site-container grid gap-12 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-5"><p className="eyebrow eyebrow-inverse">Central de acompanhamento</p><h2 className="display-condensed text-[clamp(4rem,8vw,7.5rem)] uppercase">Onde está<br /><span className="text-white/35">sua carga?</span></h2><p className="mt-7 max-w-md text-base leading-7 text-white/62">Tenha em mãos o CNPJ ou CPF do remetente e o número da nota fiscal, pedido ou coleta.</p></div>
          <div className="rounded-2xl border border-white/15 bg-white/[.04] p-5 sm:p-8 lg:col-span-6 lg:col-start-7">
